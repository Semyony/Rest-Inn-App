...
const fetchTypes = () => {
  return axios
    .get("https://mysterious-caverns-77924.herokuapp.com/property/list")
    .then(({ data }) => {
      return data;
    })
    .catch((err) => {
...
const Properties = () => {
  ...
  React.useEffect(() => {
    fetchTypes().then((data) => {
      setProperties((prevState) => [...prevState, ...data]);
      console.log(data);
    });
  }, []);
        ...
        {properties.map((property, index) => (
          <Grid item xs={12} md={6}>
            <CardActionArea component="a">
              <Link style={{textDecoration: 'none',}} to={"/property"} state={{ id: property._id }}>
